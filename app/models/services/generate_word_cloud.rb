module Services
	...
	class GenerateWordCloud
		...
		WORD_CLOUD_PROMPT = %{
			You are going to help me create a word cloud. Generate a word frequency histogram from this corpus. Clean the text first by removing common words (stopwords), punctuation (except for possessives and contractions), and other unnecessary elements. Return the results as JSON, using this format:
