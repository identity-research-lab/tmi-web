module Services
	class SuggestCategories
		...
		PROMPT = %{
			You are a social researcher doing qualitative analysis on identity-related survey data. Please generate a list of no more than 8 suggested categories from a list of provided codes. The categories should be all lowercase and contain no punctuation. Use this JSON as the output format:
		...
		# Uses the OpenAI client to pass the prompt and text through the API for category generation.
		def perform
